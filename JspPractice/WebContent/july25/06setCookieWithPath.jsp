...
<%
	Cookie cookie1 = new Cookie("path1", 
			URLEncoder.encode("경로:/KH21/july24/path1", "euc-kr"));
	cookie1.setPath("/KH21/july24/path1");
	...
	Cookie cookie4 = new Cookie("path4",
			URLEncoder.encode("경로:/KH21/july24/path2", "euc-kr"));
	cookie4.setPath("/KH21/july24/path2");
